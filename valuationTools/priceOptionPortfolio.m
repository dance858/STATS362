function [portfolioPrice, portfolioDeltas, portfolioGammas, portfolioTheta] = ...
...
for i = 1:nAssets
    ...
    % dt.
    for j = 1:nPut
       [P, delta, gamma, theta] = blackScholesPut(St(i) + dS(i), T, t + dt, r, KPut(i, j), volatility);
